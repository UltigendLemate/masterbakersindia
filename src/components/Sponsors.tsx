...
const Sponsors = () => {
    ...
    const sponsors=  [
        ...
        {
          "img": "/sigma.png",
          "link" : "https://www.sigmasrl.com/en/",
          "mini": "Sigma SRL specializes in delivering cutting-edge pastry, pizza, and bakery machinery, all crafted in Italy to elevate culinary creations.",
          "text": "Sigma SRL specializes in delivering cutting-edge pastry, pizza, and bakery machinery, all crafted in Italy to elevate culinary creations. Their advanced equipment includes planetary mixers, twin-arm mixers, and professional dough sheeters, ensuring impeccable mixing for everything from delicate creams to complex doughs. Sigma’s innovative pizza machines streamline every step of pizza preparation, enhancing both quality and efficiency. For artisan bakeries, they offer robust spiral mixers, twin-arm mixers, and precision dividers for perfect dough production, along with comprehensive solutions for dividing and forming bakery products. Sigma SRL provides unparalleled reliability and performance, with their full range of solutions available through DGS Sales Pvt. Ltd. in India."
        },
        {
