...
export default function Contact() {
  ...
  return (
    <div id="Contact" className=" mx-auto font-mon px-3 py-5 mb-10 mt-10">
      <h1 className="text-5xl md:text-7xl text-primary  text-center  heading">
        CONTACT US
      </h1>

      <section className="py-5 overflow-hidden relative z-10 md:mt-7">
        <div className="container mx-auto max-w-screen-xl ">
          <div className="flex flex-wrap lg:justify-between w-full flex-col-reverse md:flex-row px-4 md:px-0  -mr-4">
            <div className="w-full md:mx-2 mt-7 md:mt-0 lg:w-1/2 xl:w-[50%] md:px-4 -ml-px  md:ml-10">
              <div className="bg-white text-black relative rounded-lg p-8 sm:p-12 shadow-[0_0px_10px_rgba(0,0,0,0.25)] ">
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div>
                    <button
                      ...
                      onClick={sendEmail}
                      className="
                                            lg:text-base text-base w-full bg-primary mb-2 lg:mb-0 hover:bg-green-700 rounded-lg text-white p-2 lg:px-6 text-center font-semibold hover:cursor-pointer decoration-green-500 underline-offset-8 lg:hover:text-white transition-all duration-40
                        "
                    >
                      Send Message
                    </button>
            ...
            <div className="w-full lg:w-1/2 xl:w-[43%]    md:px-4">
              <div className=" mb-12 lg:mb-0">
                <p className="text-base md:text-lg text-body-color leading-relaxed mb-9 text-justify">
                  Get connected to us just with an E-mail, and get us through
                  your doubts, queries, problems and suggestions. We reply
                ...
                <div className="mb-8 flex w-full max-w-[370px] ">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color md:text-lg text-base">
                      +91 9811136837, +91 9810315463
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px] ">
