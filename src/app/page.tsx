    ...
    <main className="flex h-screen flex-col items-center justify-between">
      ...
      <div className="md:h-full py-5 px-3 bg-primary-foreground w-full mt-5 flex flex-col justify-center gap-5">
        ...
        <div className="flex justify-center gap-10">
          <Dialog>
            <DialogTrigger>
              <Image src={"/ihe.png"} width={350} height={100} alt="IHE expo" />
            </DialogTrigger>
            <DialogContent className="max-h-[60vh] overflow-y-scroll app-scrollbar">
              ...
              These include kitchen equipment, food and beverages, furnishings,
              and technology solutions. In addition, the event offers valuable
          ...
          <Dialog>
            ...
            <DialogContent className="max-h-[60vh] overflow-y-scroll app-scrollbar">
              ...
              industry, published by Hammer Publishers Pvt. Ltd. It stands out
              as one of the few magazines in India exclusively focused on this
